...
protoc.exe -I=./ --cpp_out=./ ./Ingame.proto
...
XCOPY /Y Ingame.pb.h "../../../GameServer"
XCOPY /Y Ingame.pb.cc "../../../GameServer"
...
XCOPY /Y Ingame.pb.h "../../../DummyClient"
XCOPY /Y Ingame.pb.cc "../../../DummyClient"
